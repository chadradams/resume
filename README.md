...
- Design human-in-the-loop planning and review patterns for agentic systems, keeping clinical and business experts in control of consequential decisions — including a production system serving nearly 50 compliance reviewers for AI-assisted press releases and internal communications, with data residency enforced and PII redacted before model processing.
